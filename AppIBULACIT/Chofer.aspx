        ...
        <div id="myModal" class="modal">
            <form class="modal-content animate" runat="server">
                ...
                <div class="container">
                    ...
                    <asp:TextBox ID="txtEmail" Placeholder="Correo electronico" runat="server"></asp:TextBox>
                    ...
                    <asp:TextBox ID="txtFechaNacimiento" Placeholder="Fecha de nacimiento" runat="server"></asp:TextBox>
                    ...
                    <asp:TextBox ID="txtPassword" Placeholder="Contraseña" TextMode="Password" runat="server"></asp:TextBox>
                    ...
                    <asp:TextBox ID="txtConfirmarPassword" Placeholder="Confirmar contraseña" TextMode="Password" runat="server"></asp:TextBox>
